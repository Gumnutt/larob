 ...
 *
 * @see https://github.com/platformsh-templates/drupal10/blob/master/web/sites/default/settings.platformsh.php
 */
...
$solr_server_name = 'solr_database';
...
$config['config_split.config_split.platformsh']['status'] = TRUE;
$config["config_split.config_split.fastly"]["status"] = FALSE;
